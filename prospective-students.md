...
1. **Restoring Forests for Whom?** This project in Malawi is surveying and mapping forest conditions and current forest use among rural villagers, assessing the ecological and social success of existing forest restoration projects, and designing and implementing forest restoration projects that restore historical ecosystem function while meeting the more immediate needs of local communities.
